#!/usr/bin/env python3
"""In-VM driver for the scx_simple sched_ext smoke test.
...
# 16 MiB per CPU. The default (~1.4 MiB) is far too small for a 5 s
# scx_simple run: hundreds of thousands of enqueue/select_cpu trace events
# evict the early init lines and any dispatch lines logged before the
...
def log(msg: str) -> None:
    print(f"[scx_simple_test] {msg}", flush=True)
